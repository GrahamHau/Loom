...
export function defaultSettings() {
  return {
    ...
    llm_max_concurrency: Number(process.env.LLM_MAX_CONCURRENCY || 1),
    llm_min_interval_ms: Number(process.env.LLM_MIN_INTERVAL_MS || 1200),
    llm_retry_max_attempts: Number(process.env.LLM_RETRY_MAX_ATTEMPTS || 3),
    llm_retry_base_ms: Number(process.env.LLM_RETRY_BASE_MS || 1500),
